 ...
 * LAB03 — STAGE 1: encje.
 *
 * Ten plik sprawdza istnienie i strukturę tabel dla encji LAB03:
 * - Event
 * - UserEvent
 * - WorkoutSession
 * - Achievement
 *
 * Test nie używa repozytoriów — sprawdza tylko, czy encje JPA poprawnie tworzą tabele.
 *
 * Wymagane nazwy tabel:
 * - event
 * - user_event
 * - workout_session
 * - achievement
